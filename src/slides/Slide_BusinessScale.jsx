export default function Slide_BusinessScale() {
  const billable = [
    { year: '2024', value: '$6.9M', pct: 35, projected: false },
    { year: '2025', value: '$15.6M', pct: 78, projected: false },
    { year: '2026', value: '$20M', pct: 100, projected: true, actualPct: 30, actualLabel: '$6.0M YTD' },
  ]
  ...
  return (
    ...
    >
      ...
      >
        <BarChart label="Billable income" bars={billable} />
      </div>
